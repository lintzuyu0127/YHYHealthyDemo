...
public class TasteViewAdapter extends BaseAdapter {
    private Context context;
    private int lastPosition;
    private String[] str = null;

    public TasteViewAdapter(Context context) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TasteViewAdapter.ViewHolder holder = null;
        if (view == null) {
            holder = new TasteViewAdapter.ViewHolder();
            ...
            holder = (TasteViewAdapter.ViewHolder) view.getTag();
        }
