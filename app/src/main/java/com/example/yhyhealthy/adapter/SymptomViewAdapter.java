...
public class SymptomViewAdapter extends BaseAdapter {
    private Context context;
    private int lastPosition;
    private String[] str = null;

    public SymptomViewAdapter(Context context) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        SymptomViewAdapter.ViewHolder holder = null;
        if (view == null) {
            holder = new SymptomViewAdapter.ViewHolder();
            ...
            holder = (SymptomViewAdapter.ViewHolder) view.getTag();
        }
