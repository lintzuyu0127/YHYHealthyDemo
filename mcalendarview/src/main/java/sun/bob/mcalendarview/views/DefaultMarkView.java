...
public class DefaultMarkView extends BaseMarkView {
    ...
    private Context context;  //2021/02/24 leona
    ...
    private void initLayoutWithStyle(MarkStyle style){
        ...
        switch (style.getStyle()){
            case MarkStyle.DEFAULT:
                ...
                return;
            case MarkStyle.PREIOD: //20201224 add by leona 空心圓
                this.setLayoutParams(matchParentParams);
                this.setOrientation(HORIZONTAL);
                ...
                circleDrawable.getPaint().setPathEffect(new DashPathEffect(new float[]{30f,20f},1f)); //30:實線 20:虛線
            ...
            case MarkStyle.BACKGROUND:
                ...
                this.addView(textView);
                return;
            case MarkStyle.MENSTRUAL:   //20201224 add by leona
                this.setLayoutParams(matchParentParams);
                this.setOrientation(HORIZONTAL);
                textView.setTextColor(Color.WHITE);
